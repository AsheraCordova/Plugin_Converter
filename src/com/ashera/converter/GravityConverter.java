...
public class GravityConverter extends AbstractBitFlagConverter {
	private static Map<String, Integer> gravityMap = new HashMap<>();
	...
	static {
		...
		gravityMap.put("top", TOP);
		gravityMap.put("bottom", BOTTOM);
		gravityMap.put("left", LEFT);
		gravityMap.put("right", RIGHT);
		gravityMap.put("center_vertical", CENTER_VERTICAL);
		gravityMap.put("fill_vertical", FILL_VERTICAL);
		gravityMap.put("center_horizontal", CENTER_HORIZONTAL);
		gravityMap.put("center", CENTER);
		gravityMap.put("fill", 0x77);
		gravityMap.put("clip_vertical", CLIP_VERTICAL);
		gravityMap.put("clip_horizontal", CLIP_HORIZONTAL);
		gravityMap.put("start", START);
		gravityMap.put("end", END);
		gravityMap.put("fill_horizontal", FILL_HORIZONTAL);
	}
	...
	public Collection<Integer> getReverseMappingFlags() {
		return Arrays.asList(VERTICAL_GRAVITY_MASK, HORIZONTAL_GRAVITY_MASK, CLIP_VERTICAL, CLIP_HORIZONTAL);
	}
}
