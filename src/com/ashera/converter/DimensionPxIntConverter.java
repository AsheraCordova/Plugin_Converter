...
public class DimensionPxIntConverter implements IConverter<Integer, String> {
    @Override
        ...
        if (dimen != null) {
            ...
            if (dimen.endsWith("px")) {
                ...
                throw new RuntimeException(
                        "The dimension can be match_parent/wrap_content or should be expressed in px");
            }
        }
